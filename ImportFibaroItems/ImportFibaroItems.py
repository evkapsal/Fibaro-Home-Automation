...
#######################################################
#Switch (bool) for Sending Fake Data to Azure IOT Hub.
#In case you don't want to send Fake data,
#change the values to False
########################################################
...
#######################################################
#Switch (bool) to Select Sending Data to Azure IOT Hub
#or InfluxDB/Grafana or Network Devices(Zabbix)
#Change the values to False in order to disable
########################################################
SendAzureIOTData = True
SendInfluxDBData = True
GetNetDeviceData = False
########################################################
